...
my_set = {1,2,3,'anna', 'nikolay', 2,3,1,5,10,'max', 'anna'} #созданной переменной создала множество
print(my_set)
my_set.add(0.6),my_set.add('active'),my_set.add((7,7,7)) #добавила 3 элемента по множества
print(my_set)
my_set.remove((7,7,7)) #удаляб элемент из множества
print(my_set)
